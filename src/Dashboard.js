                        ...
                        <Clock/>
                        {
                            compareGraph ?
                                <div className="row" style={{marginTop:"10%"}}>
                                    ...
                                    <div className="col-6" style={{textAlign:"center"}}>
                                        <button type="button" onClick={()=>{addCompareTopic("IEQ")}} disabled={compareTopics.includes("IEQ") ? false : disableTopics} className={compareTopics.includes("IEQ")?"btn btn-primary btn-topic":"btn btn-white-border btn-topic"}>{titles.IEQ[props.ita?"it":"en"]}</button>
                                        <button type="button" onClick={()=>{addCompareTopic("Temp")}} disabled={compareTopics.includes("Temp") ? false : disableTopics} className={compareTopics.includes("Temp")?"btn btn-primary btn-topic":"btn btn-white-border btn-topic"}>{titles.Temp[props.ita?"it":"en"]}</button>
                                        <button type="button" onClick={()=>{addCompareTopic("Air")}} disabled={compareTopics.includes("Air") ? false : disableTopics} className={compareTopics.includes("Air")?"btn btn-primary btn-topic":"btn btn-white-border btn-topic"}>{titles.Air[props.ita?"it":"en"]}</button>
                                        <button type="button" onClick={()=>{addCompareTopic("Light")}} disabled={compareTopics.includes("Light") ? false : disableTopics} className={compareTopics.includes("Light")?"btn btn-primary btn-topic":"btn btn-white-border btn-topic"}>{titles.Light[props.ita?"it":"en"]}</button>
                                        <button type="button" onClick={()=>{addCompareTopic("Sound")}} disabled={compareTopics.includes("Sound") ? false : disableTopics} className={compareTopics.includes("Sound")?"btn btn-primary btn-topic":"btn btn-white-border btn-topic"}>{titles.Sound[props.ita?"it":"en"]}</button>
                                        <button type="button" onClick={()=>{addCompareTopic("T")}} disabled={compareTopics.includes("T") ? false : disableTopics} className={compareTopics.includes("T")?"btn btn-primary btn-topic":"btn btn-white-border btn-topic"}>{titles.T[props.ita?"it":"en"]}</button>
                                        <button type="button" onClick={()=>{addCompareTopic("RH")}} disabled={compareTopics.includes("RH") ? false : disableTopics} className={compareTopics.includes("RH")?"btn btn-primary btn-topic":"btn btn-white-border btn-topic"}>{titles.RH[props.ita?"it":"en"]}</button>
                                        <button type="button" onClick={()=>{addCompareTopic("SPL")}} disabled={compareTopics.includes("SPL") ? false : disableTopics} className={compareTopics.includes("SPL")?"btn btn-primary btn-topic":"btn btn-white-border btn-topic"}>{titles.SPL[props.ita?"it":"en"]}</button>
                                    </div>
                                    <div className="col-6" style={{textAlign:"center"}}>
                                        <button type="button" onClick={()=>{addCompareTopic("E")}} disabled={compareTopics.includes("E") ? false : disableTopics} className={compareTopics.includes("E")?"btn btn-primary btn-topic":"btn btn-white-border btn-topic"}>{titles.E[props.ita?"it":"en"]}</button>
                                        <button type="button" onClick={()=>{addCompareTopic("NO2")}} disabled={compareTopics.includes("NO2") ? false : disableTopics} className={compareTopics.includes("NO2")?"btn btn-primary btn-topic":"btn btn-white-border btn-topic"}>{titles.NO2[props.ita?"it":"en"]}</button>
                                        <button type="button" onClick={()=>{addCompareTopic("VOC")}} disabled={compareTopics.includes("VOC") ? false : disableTopics} className={compareTopics.includes("VOC")?"btn btn-primary btn-topic":"btn btn-white-border btn-topic"}>{titles.VOC[props.ita?"it":"en"]}</button>
                                        <button type="button" onClick={()=>{addCompareTopic("CH2O")}} disabled={compareTopics.includes("CH2O") ? false : disableTopics} className={compareTopics.includes("CH2O")?"btn btn-primary btn-topic":"btn btn-white-border btn-topic"}>{titles.CH2O[props.ita?"it":"en"]}</button>
                                        <button type="button" onClick={()=>{addCompareTopic("CO")}} disabled={compareTopics.includes("CO") ? false : disableTopics} className={compareTopics.includes("CO")?"btn btn-primary btn-topic":"btn btn-white-border btn-topic"}>{titles.CO[props.ita?"it":"en"]}</button>
                                        <button type="button" onClick={()=>{addCompareTopic("CO2")}} disabled={compareTopics.includes("CO2") ? false : disableTopics} className={compareTopics.includes("CO2")?"btn btn-primary btn-topic":"btn btn-white-border btn-topic"}>{titles.CO2[props.ita?"it":"en"]}</button>
                                        <button type="button" onClick={()=>{addCompareTopic("PM2.5")}} disabled={compareTopics.includes("PM2.5") ? false : disableTopics} className={compareTopics.includes("PM2.5")?"btn btn-primary btn-topic":"btn btn-white-border btn-topic"}>{titles["PM2.5"][props.ita?"it":"en"]}</button>
                                        <button type="button" onClick={()=>{addCompareTopic("PM10")}} disabled={compareTopics.includes("PM10") ? false : disableTopics} className={compareTopics.includes("PM10")?"btn btn-primary btn-topic":"btn btn-white-border btn-topic"}>{titles.PM10[props.ita?"it":"en"]}</button>
                                    </div>
                                </div>
                                :
                                <>
